export default function PrivacyPolicy() {
    return (
        <div className="page-pad">
            {/* Full-width content rail aligned with header/footer */}
            <div className="content-rail">
                {/* Reading-width container INSIDE the rail */}
                <div className="max-w-3xl">
                    <h1 className="h1">Bhashamitra Privacy Policy</h1>
                    ...
                    {/* Collection */}
                    <h2 className="mt-8 h2">Collection and Use of User Information</h2>
                    ...
                    <p className="mt-3 text-slate-700">We use this information to:</p>
                    ...
                    {/* User Choices */}
                    <h2 className="mt-8 h2">User Choices</h2>
                    ...
                    {/* Cookies */}
                    <h2 className="mt-8 h2">Cookies</h2>
                    ...
                    {/* Security */}
                    <h2 className="mt-8 h2">Security</h2>
                    ...
                    {/* Updates */}
                    <h2 className="mt-8 h2">Updating Your Information</h2>
                    ...
                    {/* Changes */}
                    <h2 className="mt-8 h2">Changes to This Policy</h2>
